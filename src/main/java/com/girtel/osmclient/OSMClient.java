...
public class OSMClient
{
    ...
    {
        OSMClient osmClient = new OSMClient(OSMConstants.OSMClientVersion.SOL_005, "10.68.48.107","admin","admin");
...
//        NSConfiguration config = new NSConfiguration();
//        config.addVNFoption("1","bedminster");
//        config.addVNFoption("2", "pluto");
//
//        System.out.println(osmClient.createNS("metro_haul_control_plane_demo_nsd","default","metro_haul_control_plane_demo_nsd","bedminster", config));
